...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="WeatherBot" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.home.server.TelegramBot %CMD_LINE_ARGS%
